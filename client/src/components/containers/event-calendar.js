...
class EventCalendar extends React.Component {
    ...
    renderMonthCSwitcher(){
        return <div className="month-switcher">
            <div className="month-switcher-button" onClick={() => this.props.switchMonth(-1)}>{this.props.leftChangeButton}</div>
            <div>{this.state.today.year + ' ' + months[this.state.today.month]}</div>
            <div className="month-switcher-button" onClick={() => this.props.switchMonth(1)}>{this.props.rightChangeButton}</div>
        </div>
    }
